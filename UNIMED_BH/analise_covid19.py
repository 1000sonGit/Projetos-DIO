...
# Vamos utilizar uma função para corrigir os nomes das colunas
import re
...
# Vamos verificar quantos Estados temos informações no Brasil
...
# PREDIZENDO O NÚMERO DE CASOS CONFIRMADOS COM AUTO-ARIMA
